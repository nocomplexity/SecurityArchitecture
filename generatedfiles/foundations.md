...
{octicon}`book;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`smiley;1em;caption-text` **Epochalypse Project**
^^^
...
:::{grid-item-card}
{octicon}`pencil;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`pencil;1em;caption-text` **IDPro Body of Knowledge**
^^^
...
{octicon}`book;1em;caption-text` **IoT Security Foundation (IoTSF)**
^^^
...
{octicon}`report;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`briefcase;1em;caption-text` **Open Quantum Safe (OQS) project**
^^^
...
:::{grid-item-card}
{octicon}`light-bulb;1em;caption-text` **OpenChain Project**
^^^
...
{octicon}`tag;1em;caption-text` **OpenSCAP**
^^^
...
{octicon}`note;1em;caption-text` **SIE Europe**
^^^
...
:::{grid-item-card}
{octicon}`megaphone;1em;caption-text` **Spamhaus Project**
^^^
...
{octicon}`zap;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`pencil;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
{octicon}`tools;1em;caption-text` **The Open Worldwide Application Security Project (OWASP)**
^^^
