...
{octicon}`zap;1em;caption-text` **Apache Log4j Vulnerability Guidance**
^^^
...
{octicon}`cross-reference;1em;caption-text` **Meltdown and Spectre**
^^^
...
{octicon}`smiley;1em;caption-text` **The Marvin Attack**
^^^
