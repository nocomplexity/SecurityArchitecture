...
{octicon}`light-bulb;1em;caption-text` **Applied Cryptography 101: Building Blocks**
^^^
...
{octicon}`megaphone;1em;caption-text` **Basic course on security awareness**
^^^
...
:::{grid-item-card}
{octicon}`telescope;1em;caption-text` **CTF Field Guide**
^^^
...
{octicon}`eye;1em;caption-text` **CTFtime**
^^^
...
{octicon}`note;1em;caption-text` **Capture The Flag 101**
^^^
...
{octicon}`book;1em;caption-text` **Data Protection**
^^^
...
{octicon}`smiley;1em;caption-text` **Developing Secure Software**
^^^
...
{octicon}`thumbsup;1em;caption-text` **MITRE:Cyber Threat Intelligence Training**
^^^
...
{octicon}`light-bulb;1em;caption-text` **Malware Analysis**
^^^
...
{octicon}`smiley;1em;caption-text` **OWASP Juice Shop**
^^^
...
:::{grid-item-card}
{octicon}`briefcase;1em;caption-text` **Open-Source Phishing Framework**
^^^
...
:::{grid-item-card}
{octicon}`book;1em;caption-text` **Security By Design**
^^^
...
{octicon}`pencil;1em;caption-text` **Security awareness base course**
^^^
...
{octicon}`hubot;1em;caption-text` **Security risks of untrusted WiFi networks**
^^^
...
:::{grid-item-card}
{octicon}`cross-reference;1em;caption-text` **Sha256 algorithm explained**
^^^
...
{octicon}`stack;1em;caption-text` **The Animated Elliptic Curve**
^^^
...
:::{grid-item-card}
{octicon}`stack;1em;caption-text` **The Fuzzing Book**
^^^
...
{octicon}`stack;1em;caption-text` **The Illustrated TLS 1.3 Connection**
^^^
...
{octicon}`zap;1em;caption-text` **Wireshark Labs**
^^^
...
:::{grid-item-card}
{octicon}`stack;1em;caption-text` **eBPF.party**
^^^
