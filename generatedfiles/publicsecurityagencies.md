...
{octicon}`thumbsup;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
{octicon}`smiley;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
{octicon}`heart;1em;caption-text` **ENISA**
^^^
...
{octicon}`tag;1em;caption-text` **French Cybersecurity Agency**
^^^
...
{octicon}`telescope;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`eye;1em;caption-text` **The Federal Risk and Authorization Management Program (FedRAMP)**
^^^
...
{octicon}`report;1em;caption-text` **The National Cyber Security Centre(UK)**
^^^
