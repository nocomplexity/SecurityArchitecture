...
{octicon}`eye;1em;caption-text` **Apache Log4j Vulnerability Guidance**
^^^
...
{octicon}`report;1em;caption-text` **CacheWarp**
^^^
...
{octicon}`smiley;1em;caption-text` **Copy Fail**
^^^
...
{octicon}`check-circle;1em;caption-text` **Downfall attacks**
^^^
...
{octicon}`report;1em;caption-text` **Meltdown and Spectre**
^^^
...
{octicon}`smiley;1em;caption-text` **The DROWN Attack**
^^^
...
+++
[Read more or use this reference »](https://drownattack.com/)
:::


:::{grid-item-card}
:link: https://people.redhat.com/~hkario/marvin/ 
{octicon}`stack;1em;caption-text` **The Marvin Attack**
^^^
...
:::{grid-item-card}
{octicon}`note;1em;caption-text` **XZ Utils backdoor**
^^^

```{image} https://upload.wikimedia.org/wikipedia/commons/6/67/XZ_logo_contributed_by_Jia_Tan.png 
:height: 100px 
```
A very advanced planned attach. A good readable summary can be found in https://en.wikipedia.org/wiki/XZ_Utils_backdoor or many other sites. Everyone into security should study the way this backdoor was created. Learning is key for security!.
+++
[Read more or use this reference »](https://codeberg.org/krisvanrens/slides/raw/branch/main/xz-backdoor-talk-2026/talk.pdf)
:::
...
+++
[Read more or use this reference »](https://cryptography101.ca/crypto101-building-blocks/)
:::


:::{grid-item-card}
:link: https://teamdigitale.github.io/security-awareness/en/ 
{octicon}`tag;1em;caption-text` **Basic course on security awareness**
^^^
...
+++
[Read more or use this reference »](https://teamdigitale.github.io/security-awareness/en/)
:::


:::{grid-item-card}
{octicon}`note;1em;caption-text` **CTF Field Guide**
^^^
...
+++
[Read more or use this reference »](https://trailofbits.github.io/ctf/index.html)
:::


:::{grid-item-card}
:link: https://ctftime.org/ 
{octicon}`cross-reference;1em;caption-text` **CTFtime**
^^^
...
+++
[Read more or use this reference »](https://ctftime.org/)
:::


:::{grid-item-card}
:link: https://ctf101.org/ 
{octicon}`telescope;1em;caption-text` **Capture The Flag 101**
^^^
...
+++
[Read more or use this reference »](https://ctf101.org/)
:::


:::{grid-item-card}
{octicon}`tag;1em;caption-text` **Computer Networks: A Systems Approach**
^^^
...
+++
[Read more or use this reference »](https://book.systemsapproach.org/index.html)
:::


:::{grid-item-card}
:link: https://widgets.weforum.org/blockchain-toolkit/data-protection/index.html 
{octicon}`megaphone;1em;caption-text` **Data Protection**
^^^
...
{octicon}`bookmark;1em;caption-text` **Developing Secure Software**
^^^
...
+++
[Read more or use this reference »](https://training.linuxfoundation.org/training/developing-secure-software-lfd121/)
:::


:::{grid-item-card}
:link: https://widgets.weforum.org/blockchain-toolkit/digital-identity/index.html#q01 
{octicon}`project;1em;caption-text` **Digital Identity**
^^^
...
{octicon}`eye;1em;caption-text` **MITRE:Cyber Threat Intelligence Training**
^^^
...
+++
[Read more or use this reference »](https://attack.mitre.org/resources/training/cti/)
:::


:::{grid-item-card}
:link: https://github.com/RPISEC/Malware 
{octicon}`zap;1em;caption-text` **Malware Analysis**
^^^
Developed and used by RPISEC to teach Malware Analysis. Free to use and to improve.
+++
[Read more or use this reference »](https://github.com/RPISEC/Malware)
:::


:::{grid-item-card}
:link: http://securitybydesign.nocomplexity.com 
{octicon}`checklist;1em;caption-text` **Mastering Security By Design**
^^^
...
{octicon}`megaphone;1em;caption-text` **Mastering Security Testing for Python Applications**
^^^
...
{octicon}`note;1em;caption-text` **OWASP Juice Shop**
^^^
...
+++
[Read more or use this reference »](http://owasp-juice.shop)
:::


:::{grid-item-card}
{octicon}`stack;1em;caption-text` **Open-Source Phishing Framework**
^^^
...
+++
[Read more or use this reference »](https://getgophish.com/)
:::


:::{grid-item-card}
:link: https://github.com/teamdigitale/security-awareness 
{octicon}`telescope;1em;caption-text` **Security awareness base course**
^^^
...
+++
[Read more or use this reference »](https://github.com/teamdigitale/security-awareness)
:::


:::{grid-item-card}
:link: https://lolwifi.network/ 
{octicon}`briefcase;1em;caption-text` **Security risks of untrusted WiFi networks**
^^^
Is Untrusted (Public) WiFi Safe? A question that divides security professionals. A great learning quizz for everyone!
+++
[Read more or use this reference »](https://lolwifi.network/)
:::


:::{grid-item-card}
{octicon}`package;1em;caption-text` **Sha256 algorithm explained**
^^^
...
+++
[Read more or use this reference »](https://sha256algorithm.com/)
:::


:::{grid-item-card}
:link: https://curves.xargs.org/ 
{octicon}`thumbsup;1em;caption-text` **The Animated Elliptic Curve**
^^^
...
+++
[Read more or use this reference »](https://curves.xargs.org/)
:::


:::{grid-item-card}
:link: https://cyberlaw.ccdcoe.org/wiki/Main_Page 
{octicon}`bookmark;1em;caption-text` **The Cyber Law Toolkit**
^^^
...
+++
[Read more or use this reference »](https://cyberlaw.ccdcoe.org/wiki/Main_Page)
:::
...
+++
[Read more or use this reference »](https://www.fuzzingbook.org/)
:::


:::{grid-item-card}
:link: https://tls13.xargs.org/ 
{octicon}`checklist;1em;caption-text` **The Illustrated TLS 1.3 Connection**
^^^
...
+++
[Read more or use this reference »](https://tls13.xargs.org/)
:::


:::{grid-item-card}
:link: http://overthewire.org/wargames/ 
{octicon}`eye;1em;caption-text` **Wargames**
^^^
...
+++
[Read more or use this reference »](http://overthewire.org/wargames/)
:::


:::{grid-item-card}
:link: https://gaia.cs.umass.edu/kurose_ross/wireshark.php 
{octicon}`eye;1em;caption-text` **Wireshark Labs**
^^^
...
+++
[Read more or use this reference »](https://gaia.cs.umass.edu/kurose_ross/wireshark.php)
:::
...
+++
[Read more or use this reference »](https://ebpf.party/)
:::
...
{octicon}`heart;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`file;1em;caption-text` **Epochalypse Project**
^^^
...
{octicon}`smiley;1em;caption-text` **FIRST**
^^^
...
:::{grid-item-card}
{octicon}`package;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`report;1em;caption-text` **IDPro Body of Knowledge**
^^^
...
{octicon}`cross-reference;1em;caption-text` **Internet Security Research Group**
^^^
...
:height: 100px 
```
Gglobal not-for-profit membership association dedicated to making the connected world secure. 
+++
[Read more or use this reference »](https://iotsecurityfoundation.org/ )
:::


:::{grid-item-card}
:link: https://www.misp-project.org/ 
{octicon}`eye;1em;caption-text` **MISP - Threat Intelligence Sharing Platform**
^^^
...
{octicon}`project;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`stack;1em;caption-text` **Objective-See Foundation**
^^^
...
{octicon}`tag;1em;caption-text` **Open Quantum Safe (OQS) project**
^^^
...
+++
[Read more or use this reference »](https://openquantumsafe.org/)
:::


:::{grid-item-card}
:link: https://openssf.org/ 
{octicon}`file;1em;caption-text` **Open Source Security Foundation**
^^^
...
{octicon}`book;1em;caption-text` **SIE Europe**
^^^
...
{octicon}`check-circle;1em;caption-text` **Security Research Legal Defense Fund**
^^^
...
{octicon}`file;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`project;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
+++
[Read more or use this reference »](https://cybersecurity-centre.europa.eu/)
:::


:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **The Honeynet Project**
^^^
...
{octicon}`megaphone;1em;caption-text` **The Open Worldwide Application Security Project (OWASP)**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **The Shadowserver Foundation**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **Trusted CI**
^^^
...
+++
[Read more or use this reference »](https://saif.google/)
:::
...
{octicon}`checklist;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
{octicon}`stack;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
:::{grid-item-card}
{octicon}`tag;1em;caption-text` **Cybersecurity Library of US DoD**
^^^
...
{octicon}`light-bulb;1em;caption-text` **ENISA**
^^^
...
{octicon}`hubot;1em;caption-text` **French Cybersecurity Agency**
^^^
...
:::{grid-item-card}
:link: https://lhc.lu/ 
{octicon}`tag;1em;caption-text` **Luxembourg House of Cybersecurity**
^^^
...
:::{grid-item-card}
{octicon}`package;1em;caption-text` **Luxembourg National Cybersecurity Competence Center (NC3)**
^^^
...
{octicon}`thumbsup;1em;caption-text` **NIST General information**
^^^
...
{octicon}`cross-reference;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`light-bulb;1em;caption-text` **No-More-Ransom**
^^^
...
{octicon}`eye;1em;caption-text` **The University of Iowa Information Security and Policy Office**
^^^
