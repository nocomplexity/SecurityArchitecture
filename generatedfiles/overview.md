...
{octicon}`project;1em;caption-text` **Apache Log4j Vulnerability Guidance**
^^^
...
{octicon}`cross-reference;1em;caption-text` **CacheWarp**
^^^
...
{octicon}`thumbsup;1em;caption-text` **Downfall attacks**
^^^
...
{octicon}`file;1em;caption-text` **The Marvin Attack**
^^^
...
{octicon}`thumbsup;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`note;1em;caption-text` **Center for Internet Security (CIS)**
^^^
...
{octicon}`bookmark;1em;caption-text` **Epochalypse Project**
^^^
...
:::{grid-item-card}
{octicon}`heart;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`package;1em;caption-text` **IoT Security Foundation (IoTSF)**
^^^
...
{octicon}`checklist;1em;caption-text` **MISP - Threat Intelligence Sharing Platform**
^^^
...
{octicon}`bookmark;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`pencil;1em;caption-text` **Objective-See Foundation**
^^^
...
{octicon}`verified;1em;caption-text` **Open Quantum Safe (OQS) project**
^^^
...
{octicon}`stack;1em;caption-text` **OpenSCAP**
^^^
...
{octicon}`briefcase;1em;caption-text` **SIE Europe**
^^^
...
:::{grid-item-card}
{octicon}`smiley;1em;caption-text` **Spamhaus Project**
^^^
...
{octicon}`project;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`note;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
:::{grid-item-card}
{octicon}`book;1em;caption-text` **The Shadowserver Foundation**
^^^
...
:::{grid-item-card}
{octicon}`checklist;1em;caption-text` **Trusted CI**
^^^
...
{octicon}`checklist;1em;caption-text` **NIST Cybersecurity Framework**
^^^
...
{octicon}`bookmark;1em;caption-text` **Open Security Architecture (OSA)**
^^^
...
{octicon}`megaphone;1em;caption-text` **Software Assurance Maturity Model**
^^^
...
{octicon}`hubot;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
:::{grid-item-card}
{octicon}`eye;1em;caption-text` **Cybersecurity Library of US DoD**
^^^
...
:::{grid-item-card}
{octicon}`heart;1em;caption-text` **Luxembourg National Cybersecurity Competence Center (NC3)**
^^^
...
{octicon}`stack;1em;caption-text` **NIST General information**
^^^
...
{octicon}`project;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`package;1em;caption-text` **The Federal Risk and Authorization Management Program (FedRAMP)**
^^^
...
{octicon}`verified;1em;caption-text` **The University of Iowa Information Security and Policy Office**
^^^
...
{octicon}`eye;1em;caption-text` **Secure Design Best Practice Guides**
^^^
...
{octicon}`zap;1em;caption-text` **Secure-by-Design**
^^^
...
{octicon}`bookmark;1em;caption-text` **CycloneDX**
^^^
...
{octicon}`stack;1em;caption-text` **MONARC Objects Sharing Platform**
^^^
...
:::{grid-item-card}
{octicon}`telescope;1em;caption-text` **OmniBOR**
^^^
...
:::{grid-item-card}
{octicon}`smiley;1em;caption-text` **Open Common Requirement Enumeration**
^^^
...
{octicon}`heart;1em;caption-text` **WebAuthn**
^^^
