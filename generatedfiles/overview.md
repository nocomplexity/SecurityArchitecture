...
{octicon}`eye;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
{octicon}`heart;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
{octicon}`bookmark;1em;caption-text` **ENISA**
^^^
...
:::{grid-item-card}
{octicon}`hubot;1em;caption-text` **Luxembourg National Cybersecurity Competence Center (NC3)**
^^^
...
{octicon}`file;1em;caption-text` **NIST General information**
^^^
...
{octicon}`report;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`project;1em;caption-text` **The National Cyber Security Centre(UK)**
^^^
...
{octicon}`tag;1em;caption-text` **Secure-by-Design**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **OmniBOR**
^^^
...
:::{grid-item-card}
{octicon}`project;1em;caption-text` **Open Common Requirement Enumeration**
^^^
...
{octicon}`briefcase;1em;caption-text` **WebAuthn**
^^^
