...
{octicon}`report;1em;caption-text` **Apache Log4j Vulnerability Guidance**
^^^
...
{octicon}`project;1em;caption-text` **CacheWarp**
^^^
...
{octicon}`file;1em;caption-text` **Meltdown and Spectre**
^^^
...
:::{grid-item-card}
{octicon}`check-circle;1em;caption-text` **CTF Field Guide**
^^^
...
{octicon}`heart;1em;caption-text` **CTFtime**
^^^
...
{octicon}`zap;1em;caption-text` **Capture The Flag 101**
^^^
...
:::{grid-item-card}
{octicon}`stack;1em;caption-text` **Computer Networks: A Systems Approach**
^^^
...
{octicon}`verified;1em;caption-text` **Developing Secure Software**
^^^
...
{octicon}`pencil;1em;caption-text` **Digital Identity**
^^^
...
{octicon}`report;1em;caption-text` **MITRE:Cyber Threat Intelligence Training**
^^^
...
{octicon}`telescope;1em;caption-text` **OWASP Juice Shop**
^^^
...
:::{grid-item-card}
{octicon}`telescope;1em;caption-text` **Open-Source Phishing Framework**
^^^
...
:::{grid-item-card}
{octicon}`check-circle;1em;caption-text` **Security By Design**
^^^
...
{octicon}`megaphone;1em;caption-text` **Security awareness base course**
^^^
...
{octicon}`tag;1em;caption-text` **Security risks of untrusted WiFi networks**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **Sha256 algorithm explained**
^^^
...
{octicon}`heart;1em;caption-text` **The Animated Elliptic Curve**
^^^
...
{octicon}`file;1em;caption-text` **The Cyber Law Toolkit**
^^^
...
:::{grid-item-card}
{octicon}`file;1em;caption-text` **The Fuzzing Book**
^^^
...
{octicon}`tools;1em;caption-text` **The Illustrated TLS 1.3 Connection**
^^^
...
{octicon}`report;1em;caption-text` **Wargames**
^^^
...
{octicon}`stack;1em;caption-text` **Wireshark Labs**
^^^
...
:::{grid-item-card}
{octicon}`telescope;1em;caption-text` **eBPF.party**
^^^
...
{octicon}`file;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`zap;1em;caption-text` **Center for Internet Security (CIS)**
^^^
...
{octicon}`stack;1em;caption-text` **Epochalypse Project**
^^^
...
{octicon}`eye;1em;caption-text` **FIRST**
^^^
...
:::{grid-item-card}
{octicon}`megaphone;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`stack;1em;caption-text` **IDPro Body of Knowledge**
^^^
...
{octicon}`heart;1em;caption-text` **Internet Security Research Group**
^^^
...
{octicon}`checklist;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`package;1em;caption-text` **Objective-See Foundation**
^^^
...
{octicon}`thumbsup;1em;caption-text` **Open Quantum Safe (OQS) project**
^^^
...
{octicon}`pencil;1em;caption-text` **Open Source Security Foundation**
^^^
...
{octicon}`package;1em;caption-text` **Security Research Legal Defense Fund**
^^^
...
:::{grid-item-card}
{octicon}`verified;1em;caption-text` **Spamhaus Project**
^^^
...
{octicon}`report;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`tag;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
:::{grid-item-card}
{octicon}`zap;1em;caption-text` **The Honeynet Project**
^^^
...
{octicon}`verified;1em;caption-text` **The Open Worldwide Application Security Project (OWASP)**
^^^
...
:::{grid-item-card}
{octicon}`project;1em;caption-text` **The Shadowserver Foundation**
^^^
...
{octicon}`light-bulb;1em;caption-text` **dns0.eu**
^^^
...
{octicon}`thumbsup;1em;caption-text` **Software Assurance Maturity Model**
^^^
...
{octicon}`stack;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
:::{grid-item-card}
{octicon}`stack;1em;caption-text` **Cybersecurity Library of US DoD**
^^^
...
{octicon}`thumbsup;1em;caption-text` **ENISA**
^^^
...
{octicon}`briefcase;1em;caption-text` **French Cybersecurity Agency**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **Luxembourg National Cybersecurity Competence Center (NC3)**
^^^
...
{octicon}`light-bulb;1em;caption-text` **NIST General information**
^^^
...
{octicon}`megaphone;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`smiley;1em;caption-text` **No-More-Ransom**
^^^
...
{octicon}`zap;1em;caption-text` **The Federal Risk and Authorization Management Program (FedRAMP)**
^^^
...
{octicon}`file;1em;caption-text` **Secure Design Best Practice Guides**
^^^
...
{octicon}`bookmark;1em;caption-text` **Security By Design Guide**
^^^
...
{octicon}`file;1em;caption-text` **CycloneDX**
^^^
...
:::{grid-item-card}
{octicon}`heart;1em;caption-text` **OmniBOR**
^^^
...
{octicon}`report;1em;caption-text` **WebAuthn**
^^^
