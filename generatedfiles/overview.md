...
{octicon}`thumbsup;1em;caption-text` **Apache Log4j Vulnerability Guidance**
^^^
...
{octicon}`tag;1em;caption-text` **Downfall attacks**
^^^
...
{octicon}`heart;1em;caption-text` **Meltdown and Spectre**
^^^
...
{octicon}`check-circle;1em;caption-text` **The Marvin Attack**
^^^
...
{octicon}`file;1em;caption-text` **Data Protection**
^^^
...
{octicon}`check-circle;1em;caption-text` **Digital Identity**
^^^
...
{octicon}`stack;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`verified;1em;caption-text` **Epochalypse Project**
^^^
...
{octicon}`checklist;1em;caption-text` **FIRST**
^^^
...
:::{grid-item-card}
{octicon}`thumbsup;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`file;1em;caption-text` **IDPro Body of Knowledge**
^^^
...
{octicon}`tag;1em;caption-text` **IoT Security Foundation (IoTSF)**
^^^
...
{octicon}`verified;1em;caption-text` **MISP - Threat Intelligence Sharing Platform**
^^^
...
{octicon}`package;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`bookmark;1em;caption-text` **Objective-See Foundation**
^^^
...
{octicon}`file;1em;caption-text` **Open Quantum Safe (OQS) project**
^^^
...
{octicon}`tag;1em;caption-text` **Open Source IT Risk Management**
^^^
...
{octicon}`report;1em;caption-text` **Open Source Security Foundation**
^^^
...
{octicon}`verified;1em;caption-text` **Open Source Technology Improvement Fund**
^^^
...
{octicon}`pencil;1em;caption-text` **OpenSCAP**
^^^
...
{octicon}`file;1em;caption-text` **SIE Europe**
^^^
...
{octicon}`smiley;1em;caption-text` **Security Research Legal Defense Fund**
^^^
...
{octicon}`package;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`telescope;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
:::{grid-item-card}
{octicon}`file;1em;caption-text` **The Honeynet Project**
^^^
...
{octicon}`smiley;1em;caption-text` **The Open Worldwide Application Security Project (OWASP)**
^^^
...
:::{grid-item-card}
{octicon}`check-circle;1em;caption-text` **The Shadowserver Foundation**
^^^
...
{octicon}`book;1em;caption-text` **dns0.eu**
^^^
...
{octicon}`note;1em;caption-text` **NIST Cybersecurity Framework**
^^^
...
{octicon}`stack;1em;caption-text` **Software Assurance Maturity Model**
^^^
...
{octicon}`checklist;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
:::{grid-item-card}
{octicon}`bookmark;1em;caption-text` **Cybersecurity Library of US DoD**
^^^
...
{octicon}`pencil;1em;caption-text` **French Cybersecurity Agency**
^^^
...
{octicon}`note;1em;caption-text` **NIST General information**
^^^
...
{octicon}`checklist;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`package;1em;caption-text` **No-More-Ransom**
^^^
...
{octicon}`tag;1em;caption-text` **The Federal Risk and Authorization Management Program (FedRAMP)**
^^^
...
{octicon}`smiley;1em;caption-text` **The National Cyber Security Centre(UK)**
^^^
...
{octicon}`briefcase;1em;caption-text` **The University of Iowa Information Security and Policy Office**
^^^
...
{octicon}`smiley;1em;caption-text` **Secure Design Best Practice Guides**
^^^
...
{octicon}`bookmark;1em;caption-text` **Secure-by-Design**
^^^
...
{octicon}`hubot;1em;caption-text` **Security By Design Guide**
^^^
...
:::{grid-item-card}
{octicon}`cross-reference;1em;caption-text` **Open Common Requirement Enumeration**
^^^
...
{octicon}`light-bulb;1em;caption-text` **WebAuthn**
^^^
