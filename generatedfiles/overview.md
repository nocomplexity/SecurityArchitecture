...
{octicon}`package;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
{octicon}`briefcase;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
:::{grid-item-card}
:link: https://lhc.lu/ 
{octicon}`thumbsup;1em;caption-text` **Luxembourg House of Cybersecurity**
^^^
...
:::{grid-item-card}
{octicon}`report;1em;caption-text` **Luxembourg National Cybersecurity Competence Center (NC3)**
^^^
...
{octicon}`cross-reference;1em;caption-text` **NIST General information**
^^^
...
{octicon}`verified;1em;caption-text` **New Zealand Information Security Manual**
^^^
...
{octicon}`telescope;1em;caption-text` **The University of Iowa Information Security and Policy Office**
^^^
...
{octicon}`check-circle;1em;caption-text` **Secure-by-Design**
^^^
...
{octicon}`heart;1em;caption-text` **Security By Design Guide**
^^^
...
{octicon}`eye;1em;caption-text` **MONARC Objects Sharing Platform**
^^^
...
:::{grid-item-card}
{octicon}`megaphone;1em;caption-text` **OmniBOR**
^^^
...
:::{grid-item-card}
{octicon}`zap;1em;caption-text` **Open Common Requirement Enumeration**
^^^
