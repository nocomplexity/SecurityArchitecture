...
{octicon}`pencil;1em;caption-text` **Data Protection**
^^^
...
{octicon}`tag;1em;caption-text` **CA/Browser Forum**
^^^
...
{octicon}`file;1em;caption-text` **Center for Internet Security (CIS)**
^^^
...
{octicon}`check-circle;1em;caption-text` **FIRST**
^^^
...
:::{grid-item-card}
{octicon}`briefcase;1em;caption-text` **Global Encryption Coalition**
^^^
...
{octicon}`bookmark;1em;caption-text` **Internet Security Research Group**
^^^
...
{octicon}`telescope;1em;caption-text` **IoT Security Foundation (IoTSF)**
^^^
...
{octicon}`bookmark;1em;caption-text` **MISP - Threat Intelligence Sharing Platform**
^^^
...
{octicon}`heart;1em;caption-text` **Memory Safety**
^^^
...
{octicon}`tools;1em;caption-text` **Open Source Security Foundation**
^^^
...
{octicon}`package;1em;caption-text` **Open Source Technology Improvement Fund**
^^^
...
:::{grid-item-card}
{octicon}`briefcase;1em;caption-text` **OpenChain Project**
^^^
...
{octicon}`eye;1em;caption-text` **OpenSCAP**
^^^
...
{octicon}`light-bulb;1em;caption-text` **SIE Europe**
^^^
...
{octicon}`pencil;1em;caption-text` **The Cyber Security Body Of Knowledge**
^^^
...
{octicon}`package;1em;caption-text` **The European Cybersecurity Competence Centre**
^^^
...
:::{grid-item-card}
{octicon}`briefcase;1em;caption-text` **The Honeynet Project**
^^^
...
{octicon}`heart;1em;caption-text` **The Open Worldwide Application Security Project (OWASP)**
^^^
...
:::{grid-item-card}
{octicon}`smiley;1em;caption-text` **The Shadowserver Foundation**
^^^
...
:::{grid-item-card}
{octicon}`note;1em;caption-text` **Trusted CI**
^^^
...
{octicon}`megaphone;1em;caption-text` **dns0.eu**
^^^
...
{octicon}`file;1em;caption-text` **NIST Cybersecurity Framework**
^^^
...
{octicon}`tools;1em;caption-text` **Open Security Architecture (OSA)**
^^^
...
{octicon}`telescope;1em;caption-text` **Australian Cyber Security Centre (ACSC)**
^^^
...
{octicon}`pencil;1em;caption-text` **Australian Strategic Policy Institute (ASPI)**
^^^
...
{octicon}`verified;1em;caption-text` **ENISA**
^^^
...
{octicon}`eye;1em;caption-text` **French Cybersecurity Agency**
^^^
...
:::{grid-item-card}
:link: https://lhc.lu/ 
{octicon}`hubot;1em;caption-text` **Luxembourg House of Cybersecurity**
^^^
...
{octicon}`tools;1em;caption-text` **The Federal Risk and Authorization Management Program (FedRAMP)**
^^^
...
{octicon}`eye;1em;caption-text` **The National Cyber Security Centre(UK)**
^^^
...
{octicon}`pencil;1em;caption-text` **The University of Iowa Information Security and Policy Office**
^^^
...
{octicon}`stack;1em;caption-text` **Secure-by-Design**
^^^
...
{octicon}`zap;1em;caption-text` **Security By Design Guide**
^^^
...
{octicon}`megaphone;1em;caption-text` **MONARC Objects Sharing Platform**
^^^
...
:::{grid-item-card}
{octicon}`package;1em;caption-text` **OmniBOR**
^^^
...
:::{grid-item-card}
{octicon}`eye;1em;caption-text` **Open Common Requirement Enumeration**
^^^
