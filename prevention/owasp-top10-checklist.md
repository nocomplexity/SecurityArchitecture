...
```{note}
OWASP is considered to be the gold-standard in computer security information. OWASP maintains an extensive series of cheat sheets which cover all the OWASP Top 10 and more. Below, many of the more relevant cheat sheets have been summarized. To view all the cheat sheets, check out their [Cheat Sheet Index](https://github.com/OWASP/CheatSheetSeries/blob/master/Index.md).
 ```
...
## Attribution
This section is derived from the [owasp.org top 10 project](https://github.com/OWASP/Top10) 
Or see https://owasp.org/Top10/

Copyright 2021 - OWASP Top 10 team - This work is licensed under a Creative Commons Attribution 3.0 Unported License. 

[OWASP 10 top documentation license](https://github.com/OWASP/Top10/blob/master/LICENSE): Creative Commons Attribution-ShareAlike 4.0 International Public License
